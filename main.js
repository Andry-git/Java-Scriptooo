...
class Birds extends React.Component {
  state = {
    birds: [{ avatar:"https://faunistics.com/wp-content/uploads/2019/09/1-13.jpg",
              name:"Ласточка",
              description:"Небольшая птица, длина тела 14,6—23 см, размах крыльев 31,8—35 см. Вес птицы составляет 17—24 грамм. Окраска сверху — сине-чёрная с металлическим отблеском, снизу бледно-бежевая. На лбу и передней части шеи имеются светло-коричневые пятна. Хвост длинный, с глубоким вырезом посередине. Самцы и самки выглядят приблизительно одинаково, хотя самки часто окрашены чуть менее контрастно, и их хвост чуть короче.",
              areal:"Везде, за исключением Австралии и Антарктиды",
              size:"Маленькая"},

            { avatar:"https://ryba-love.ru/wp-content/uploads/2021/07/oryol-stepnoj.jpg",
              name:"Орёл",
              description:"Орлы́ (лат. Aquila) — род хищных птиц семейства ястребиных. Длина тела 75—88 см, хвост довольно короткий, крылья широкие, до 2,4 м в размахе, ноги оперены до пальцев.",
              areal:"Распространены в Евразии, Африке и Северной Америке от лесотундры до пустынь.",
              size:"Большая"},

            { avatar:"https://img.gazeta.ru/files3/842/10785842/shutterstock_628026569-pic905-895x505-46627.jpg",
              name:"Ворона",
              description:"Во́роны (лат. Corvus) — род птиц из семейства врановых (Corvidae). Род включает виды, известные как во́роны, воро́ны, грачи и галки. Между «во́ронами» и «воро́нами» нет чёткого различия, так как эти наименования присваиваются различным видам главным образом на основе их размера: во́роны, как правило, крупнее ворон.",
